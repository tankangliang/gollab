...
func (x *Message) GetIdentifier() *Identifier {
	if x, ok := x.GetData().(*Message_Identifier); ok {
		return x.Identifier
	}
	return nil
}
...
func (x *Message) GetOutput() string {
	if x, ok := x.GetData().(*Message_Output); ok {
		return x.Output
	}
	return ""
}
...
type Message_Identifier struct {
	Identifier *Identifier `protobuf:"bytes,2,opt,name=identifier,proto3,oneof"`
}

type Message_Output struct {
	Output string `protobuf:"bytes,5,opt,name=output,proto3,oneof"`
}

func (*Message_Identifier) isMessage_Data() {}

func (*Message_Output) isMessage_Data() {}
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x6c, 0x61, 0x62, 0x1a, 0x16, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbd, 0x01,
	...
	,
...
var file_proto_message_proto_goTypes = []interface{}{
	(*Message)(nil),    // 0: github.com.tankangliang.gollab.Message
	(*Identifier)(nil), // 1: github.com.tankangliang.gollab.Identifier
}
var file_proto_message_proto_depIdxs = []int32{
	1, // 0: github.com.tankangliang.gollab.Message.identifier:type_name -> github.com.tankangliang.gollab.Identifier
...
func file_proto_message_proto_init() {
	...
	file_proto_identifier_proto_init()
	if !protoimpl.UnsafeEnabled {

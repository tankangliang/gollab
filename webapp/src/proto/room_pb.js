...
goog.exportSymbol(
    'proto.github.com.tankangliang.gollab.ConnectRequest', null, global);
goog.exportSymbol(
    'proto.github.com.tankangliang.gollab.CreateRoomRequest', null, global);
goog.exportSymbol(
    'proto.github.com.tankangliang.gollab.CreateRoomResponse', null, global);
...
goog.inherits(
    proto.github.com.tankangliang.gollab.CreateRoomRequest, jspb.Message);
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  /**
   * Creates an object representation of this proto suitable for use in Soy
   * templates. Field names that are reserved in JavaScript and will be renamed
   * to pb_name. To access a reserved field use, foo.pb_<name>, eg,
   * foo.pb_default. For the list of reserved names please see:
   *     com.google.apps.jspb.JsClassTemplate.JS_RESERVED_WORDS.
   * @param {boolean=} opt_includeInstance Whether to include the JSPB instance
   *     for transitional soy proto support: http://goto/soy-param-migration
   * @return {!Object}
   */
  proto.github.com.tankangliang.gollab.CreateRoomRequest.prototype.toObject =
   ...
   * @param {!proto.github.com.tankangliang.gollab.CreateRoomRequest} msg The
   *     msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.github.com.tankangliang.gollab.CreateRoomRequest.toObject = function(
      includeInstance, msg) {
    var f, obj = {id: jspb.Message.getFieldWithDefault(msg, 1, '')};
 ...
 */
proto.github.com.tankangliang.gollab.CreateRoomRequest.deserializeBinary =
    function(bytes) {
 ...
 * @return {!Uint8Array}
 */
proto.github.com.tankangliang.gollab.CreateRoomRequest.prototype
    .serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.github.com.tankangliang.gollab.CreateRoomRequest
      .serializeBinaryToWriter(this, writer);
 ...
 * @return {string}
 */
proto.github.com.tankangliang.gollab.CreateRoomRequest.prototype.getId =
    function() {
...
/** @param {string} value */
proto.github.com.tankangliang.gollab.CreateRoomRequest.prototype.setId =
    function(value) {
...
goog.inherits(
    proto.github.com.tankangliang.gollab.CreateRoomResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.github.com.tankangliang.gollab.CreateRoomResponse.prototype.toObject =
      function(opt_includeInstance) {
   ...
   *     instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.github.com.tankangliang.gollab.CreateRoomResponse} msg The
   *     msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.github.com.tankangliang.gollab.CreateRoomResponse.toObject = function(
      includeInstance, msg) {
    var f, obj = {accepted: jspb.Message.getFieldWithDefault(msg, 1, false)};
 ...
 */
proto.github.com.tankangliang.gollab.CreateRoomResponse.deserializeBinary =
    function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
 ...
 * @return {!Uint8Array}
 */
proto.github.com.tankangliang.gollab.CreateRoomResponse.prototype
    .serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.github.com.tankangliang.gollab.CreateRoomResponse
      .serializeBinaryToWriter(this, writer);
 ...
 * Note that Boolean fields may be set to 0/1 when serialized from a Java
 * server. You should avoid comparisons like {@code val === true/false} in those
 * cases.
 * @return {boolean}
 */
proto.github.com.tankangliang.gollab.CreateRoomResponse.prototype.getAccepted =
    function() {
  return /** @type {boolean} */ (
...
/** @param {boolean} value */
proto.github.com.tankangliang.gollab.CreateRoomResponse.prototype.setAccepted =
    function(value) {
...
goog.inherits(
    proto.github.com.tankangliang.gollab.ConnectRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.github.com.tankangliang.gollab.ConnectRequest.prototype.toObject =
      function(opt_includeInstance) {
   ...
   *     instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.github.com.tankangliang.gollab.ConnectRequest} msg The msg
 ...
 */
proto.github.com.tankangliang.gollab.ConnectRequest.deserializeBinary =
    function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.github.com.tankangliang.gollab.ConnectRequest} msg The message
 ...
 * @return {!Uint8Array}
 */
proto.github.com.tankangliang.gollab.ConnectRequest.prototype.serializeBinary =
    function() {
  var writer = new jspb.BinaryWriter();
 ...
 * @return {string}
 */
proto.github.com.tankangliang.gollab.ConnectRequest.prototype.getUser =
    function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ''));
};
...
/** @param {string} value */
proto.github.com.tankangliang.gollab.ConnectRequest.prototype.setUser =
    function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.github.com.tankangliang.gollab.ConnectRequest.prototype.getRoomid =
    function() {
...
/** @param {string} value */
proto.github.com.tankangliang.gollab.ConnectRequest.prototype.setRoomid =
    function(value) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   *     instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.github.com.tankangliang.gollab.Close} msg The msg instance
   *     to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
 ...
 */
proto.github.com.tankangliang.gollab.Close.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.github.com.tankangliang.gollab.Close} msg The message object
 *     to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.github.com.tankangliang.gollab.Close}
 */
proto.github.com.tankangliang.gollab.Close.deserializeBinaryFromReader =
    function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
 ...
 * @return {!Uint8Array}
 */
proto.github.com.tankangliang.gollab.Close.prototype.serializeBinary =
    function() {
  var writer = new jspb.BinaryWriter();

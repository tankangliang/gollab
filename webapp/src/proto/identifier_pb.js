...
goog.exportSymbol(
    'proto.github.com.tankangliang.gollab.Identifier', null, global);
...
proto.github.com.tankangliang.gollab.Identifier = function(opt_data) {
  jspb.Message.initialize(
      this, opt_data, 0, -1,
      proto.github.com.tankangliang.gollab.Identifier.repeatedFields_, null);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @param {!proto.github.com.tankangliang.gollab.Identifier} msg The msg
  ...
  proto.github.com.tankangliang.gollab.Identifier.toObject = function(
    ...
    var f, obj = {
      ...
      tripletsList: jspb.Message.toObjectList(
          msg.getTripletsList(), proto_triplet_pb.Triplet.toObject,
          includeInstance)
    };
 ...
 * @param {!proto.github.com.tankangliang.gollab.Identifier} msg The message
 *     object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.github.com.tankangliang.gollab.Identifier}
 */
proto.github.com.tankangliang.gollab.Identifier.deserializeBinaryFromReader =
    function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(
            value, proto_triplet_pb.Triplet.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.github.com.tankangliang.gollab.Identifier.prototype.serializeBinary =
    function() {
...
proto.github.com.tankangliang.gollab.Identifier.serializeBinaryToWriter =
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
        2, f, proto_triplet_pb.Triplet.serializeBinaryToWriter);
  }
};
 ...
 * @return {string}
 */
proto.github.com.tankangliang.gollab.Identifier.prototype.getValue =
    function() {
 ...
 */
proto.github.com.tankangliang.gollab.Identifier.prototype.getTripletsList =
    function() {
  return /** @type{!Array<!proto.github.com.tankangliang.gollab.Triplet>} */ (
      jspb.Message.getRepeatedWrapperField(this, proto_triplet_pb.Triplet, 2));
};


/** @param {!Array<!proto.github.com.tankangliang.gollab.Triplet>} value */
proto.github.com.tankangliang.gollab.Identifier.prototype.setTripletsList =
    function(value) {
 ...
 */
proto.github.com.tankangliang.gollab.Identifier.prototype.addTriplets =
    function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(
      this, 2, opt_value, proto.github.com.tankangliang.gollab.Triplet,
      opt_index);
};


proto.github.com.tankangliang.gollab.Identifier.prototype.clearTripletsList =
    function() {

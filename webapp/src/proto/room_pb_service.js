...
RoomServiceClient.prototype.createRoom = function createRoom(
...
RoomServiceClient.prototype.connect = function connect(
    requestMessage, metadata) {
  var listeners = {data: [], end: [], status: []};
...
RoomServiceClient.prototype.broadcast = function broadcast(
    requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
